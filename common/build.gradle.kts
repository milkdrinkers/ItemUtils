...
mavenPublishing {
    ...
    pom {
        ...
        url.set("https://github.com/milkdrinkers/ItemUtil")
        ...
        scm {
            url.set("https://github.com/milkdrinkers/ItemUtil")
            connection.set("scm:git:git://github.com/milkdrinkers/ItemUtil.git")
            developerConnection.set("scm:git:ssh://github.com:milkdrinkers/ItemUtil.git")
        }
    }
