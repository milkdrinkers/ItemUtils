...
for each branch. This allow us to review and pull in new features or improvements individually.
...
When contributing ensure your code follows existing conventions and styling. (*Any issues that arise will be noted in
your pull request.*)

## Licensing

All contributors agree to adhere to the terms and conditions of
our [Contributor License Agreement (CLA)](CONTRIBUTOR_LICENSE_AGREEMENT.md).